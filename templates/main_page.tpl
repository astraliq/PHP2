<div class="container-fluid">
					...
					<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img src="../img/img_phones/1.jpg" class="d-block w-100 h-20" alt="...">
							</div>
							<div class="carousel-item">
								<img src="../img/img_phones/2.jpg" class="d-block w-100 h-20" alt="...">
							</div>
							<div class="carousel-item">
								<img src="../img/img_phones/3.jpg" class="d-block w-100 h-20" alt="...">
							</div>
						</div>
		...
		<div class="content">
			<div class="greeting_block text-center">
				<h3 class="greeting">Добро пожаловать <br> в наш интернет-магазин!</h3>
